...
const CollabDefinition _eventsThisWeekCollab = CollabDefinition(
  ...
  heroType: 'image',
  heroImageUrl: 'asset:assets/system_collabs/events_this_week.png',
  gradientKey: 'deep',
  query: CollabQuery(),
  limit: 30,
...
const CollabDefinition _eventsTodayCollab = CollabDefinition(
  ...
  creatorAvatarUrl: null,
  heroType: 'image',
  heroImageUrl: 'asset:assets/system_collabs/events_today.png',
  gradientKey: 'sunset',
  query: CollabQuery(),
  limit: 30,
  requiresRuntime: false,
...
const CollabDefinition _eventsHighlightsYearCollab = CollabDefinition(
  ...
  creatorAvatarUrl: null,
  heroType: 'image',
  heroImageUrl: 'asset:assets/system_collabs/events_highlights_year.png',
  gradientKey: 'mint',
  query: CollabQuery(),
  limit: 30,
  requiresRuntime: false,
